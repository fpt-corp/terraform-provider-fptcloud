...
type MgpuClusterApiClient struct {
	*commons.Client
}

func newMgpuClusterApiClient(c *commons.Client) *MgpuClusterApiClient {
	return &MgpuClusterApiClient{c}
}

// NewMgpuClusterApiClient creates an exported MgpuClusterApiClient for use by other packages
func NewMgpuClusterApiClient(c *commons.Client) *MgpuClusterApiClient {
	return &MgpuClusterApiClient{c}
}

// SendGetWithInfraType sends a GET request with the infra-type and fpt-region headers set
func (m *MgpuClusterApiClient) SendGetWithInfraType(requestURL string, infraType string) ([]byte, error) {
	return m.sendGet(requestURL, infraType)
}

func (m *MgpuClusterApiClient) sendGet(requestURL string, infraType string) ([]byte, error) {
...
func (m *MgpuClusterApiClient) sendPost(ctx context.Context, requestURL string, infraType string, params interface{}) ([]byte, error) {
	u := m.Client.PrepareClientURL(requestURL)
...
func (m *MgpuClusterApiClient) sendDelete(requestURL string, infraType string) ([]byte, error) {
	u := m.Client.PrepareClientURL(requestURL)
...
func (m *MgpuClusterApiClient) sendGetV2Aware(primaryPath, fallbackPath, infraType string) ([]byte, error) {
...
func (m *MgpuClusterApiClient) sendPatchV2Aware(ctx context.Context, primaryPath, fallbackPath, infraType string, params interface{}) ([]byte, error) {
...
// fallbackPath on a 404. See sendGetV2Aware for why the fallback is needed.
func (m *MgpuClusterApiClient) sendDeleteV2Aware(primaryPath, fallbackPath, infraType string) ([]byte, error) {
...
func (m *MgpuClusterApiClient) sendRequestWithHeader(request *http.Request, infraType string) ([]byte, error) {
