...
var descriptions = map[string]string{
	...
	"max_client":              "Maximum number of clients sharing one GPU: 0 when client_type is NONE, 2-48 for MPS or TIMESLICING",
	...
	"gpu_sharing":             "How the pool's GPUs are shared between clients: client_type and max_client (optional)",
	"client_type":             "GPU sharing strategy: NONE, MPS, or TIMESLICING",
	"mig":                     "MIG (Multi-Instance GPU) partitioning for the pool: strategy and profile (optional)",
	"strategy":                "MIG strategy: NONE, SINGLE, or MIXED",
	"profile":                 "MIG profile the GPUs are partitioned into (e.g. all-1g.35gb); required when strategy is SINGLE or MIXED",
