...
var descriptions = map[string]string{
	...
	"gpu_type":                "GPU type for the pool (e.g. H200), as reported by the gpu-clusters detail endpoint; typically derived from hpc_flavor_id rather than set explicitly (optional)",
	"mig_profile":             "MIG profile for the pool (e.g. all-disabled), as reported by the gpu-clusters detail endpoint (optional)",
